...
# Admins, Channels & 
UPCH_US = environ.get('UPCH_US', 'MKV-Tv')
SUP_GRP = environ.get('SUP_GRP', 'MKV_OTT')
...
MAIN_FUNC = is_enabled((environ.get('MAIN_FUNC', "True")), True)
AUTO_DELALL = is_enabled((environ.get('AUTO_DELALL', "True")), True)
